  ...
  return (
    <div className="min-h-screen bg-gray-900 kranky-regular">
      ...
      <div className="circle_arrow">
        <Image src={ArrowLeft} width={35} alt="Seta Esquerda" className="setaE" onClick={handleClickReturn}></Image>
      </div>
        ...
        <div className="circle_arrow">
          <Image src={Arrow} width={35} alt="Seta Direita" className="setaD" onClick={handleClick}></Image>
        </div>
      </main>
    </div>
  );
